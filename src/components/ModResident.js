...
const handleGenerateQR = (resident) => {
  ...
  const vCardData = [
    ...
    `Full Name:‎ ${resident.firstName} ${resident.middleInitial || ''} ${resident.surname}`,
    `Date of Birth:‎ ${resident.dateOfBirth}`,
    `Phone Number:‎ ${resident.contactNumber}`,
    `Address:‎ ${resident.houseNumber} ${resident.street}, Purok ${resident.purok}`,
    `Barangay ID:‎ ${resident.barangayIdNumber || 'N/A'}` ,
      ...
      <div className="dashboard-layout">
        ...
        <div className="sidebar">
          ...
          <div className="sidebar-menu">
            ...
            <a href="#" className="sidebar-nav-item active " onClick={() => navigate('/mod-resident')}>
            ...
            <a href="#" className="sidebar-nav-item" onClick={() => navigate('/mod-user')}>
